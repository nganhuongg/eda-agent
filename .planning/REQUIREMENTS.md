...
- [ ] **CRIT-03**: Critic agent returns a structured `CriticVerdict` with approved flag and list of rejected claims
- [ ] **CRIT-04**: Critic agent is fully deterministic — no LLM call, no API dependency
